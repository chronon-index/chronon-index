...
- [ ] B-uc2-11 | deps: B-uc2-14, B-uc2-15 | refs: SPEC#2 AC-2.3 | Backfill data acquisition (keyless per B-uc2-02(c)): Eurostat demo_r_mwk_ts full history (2000+; 2014+ already snapshotted) + CDC r8kw-7aab (2020+) + WMD (2015-2024, snapshotted) covering ≥ 570 consecutive weeks; respect the panel-edge and censoring guards (B-uc2-15/16)
