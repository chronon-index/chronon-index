...
- [ ] A-16 | deps: A-08, A-09, A-10 | refs: RALPH#0, DEC#9 | HUMAN: review + ratify the reconstructed SPEC.md, METHODOLOGY_v0.md and seed/ artifacts (they replaced lost originals) — gates the first public print (P1) and the golden-anchor commit B-uc1-13 (RULED 2026-08-20, docs/rulings/A16_DECISIONS.md: originals were NEVER lost — RESTORE per D1, don't ratify. D2 drift confirmed original; D3 mint residual explained (float intermediate, C-0002); D4 SPEC merged with AC-1.2 rewritten; D5/D6 doc corrections applied; D7 commended. EXECUTED 2026-08-24 except the restore itself + D3b v0-original freeze: BLOCKED on chronon-index-READY.zip, not on this machine — Ben must deliver it to ~/Downloads)
...
- [ ] B-uc2-17 | deps: B-uc2-15, B-uc2-16 | refs: ruling B-uc2-02(c) follow-ups | Vintage store for both weekly feeds: append-only, one row per pull date — the prerequisite for chain-ladder backfill CORRECTION (vs censoring); costs nothing to start
- [ ] B-uc2-18 | deps: B-uc2-14 | refs: ruling B-uc2-02(c) follow-ups | ONS adapter for UK weekly deaths (Eurostat UK coverage stops post-Brexit; ONS is keyless) — separate adapter, not a WPP fallback
...
- [x] D-04 | deps: C-uc6-03, B-uc2-10 | refs: RP#IX-E6, RP#VIII, DEC | Cohort-S series (E6 over the projected mortality surface) published INFORMATIONAL with intervals alongside the measured-period settlement series (done 2026-08-25: cohort e0=78.0502, cohort-S=392.8260B on 2023 structure — INSIDE the D6-blessed 381-402B band; uplift +8.06% vs period, 0.06pp ABOVE the budget's recorded +3-8% upper — recorded as a tested FINDING, version-bump proposal due; INFORMATIONAL print with measured_share=0 honesty slots into DualSeries, settlement untouched)
